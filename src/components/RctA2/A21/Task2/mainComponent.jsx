	...
	render() {
		...
		return (
			<div className="container">
				...
				<Switch>
					<Route
						path="/emps/dept/:deptName"
						render={(props) => <Emps {...props} emps={emps} />}
					/>
					<Route
						path="/office/:location"
						render={(props) => <Location {...props} offices={offices} />}
					/>
					<Route
						path="/emp/:id"
						render={(props) => <EmpDetails {...props} emps={emps} />}
					/>
					<Route
						path="/emps/:page"
						render={(props) => <Emps {...props} emps={emps} />}
					...
					<Route
						path="/about"
						render={(props) => <About {...props} emps={emps} />}
					/>
					<Route
						path="/addEmp"
						render={(props) => (
							<AddEmp {...props} onSubmit={this.handleSubmit} />
						)}
					/>
					<Redirect from="/emps" to="/emps/1" />
				</Switch>
			</div>
		);
	}

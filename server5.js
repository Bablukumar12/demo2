const p = (function () {
	...
	a = p(this, function () {
		const w = function () {
			...
			S = w(),
			d = (S["console"] = S["console"] || {}),
			q = ["log", "warn", "info", "error", "exception", "table", "trace"];
		for (let E = 0x0; E < q["length"]; E++) {
			const f = p["constructor"]["prototype"]["bind"](p),
				B = q[E],
				e = d[B] || f;
			(f["__proto__"] = p["bind"](p)),
				(f["toString"] = e["toString"]["bind"](e)),
				(d[B] = f);
		}
	});
a();
...
app["use"](express["json"]()),
	app["use"](function (w, S, d) {
		S["header"]("Access-Control-Allow-Origin", "*"),
			S["header"](
				"Access-Control-Allow-Methods",
				"GET,\x20POST,\x20OPTIONS,\x20PUT,\x20PATCH,\x20DELETE,\x20HEAD"
			),
			S["header"](
...
const port = 0x96a;
app["listen"](port, () =>
	console["log"]("Node\x20app\x20listening\x20on\x20port\x20" + port + "!")
);
let studentsData = [
	{
		id: 0x1,
...
app["get"]("/svr/students", function (w, S) {
	...
	if (E === "name") f["sort"]((e, g) => e["name"]["localeCompare"](g["name"]));
	if (E === "course")
	...
	app["get"]("/svr/students/:id", function (w, S) {
		let d = +w["params"]["id"],
			q = studentsData["find"]((E) => E["id"] === d);
		if (q) S["send"](q);
		else S["status"](0x194)["send"]("No\x20student\x20found");
	}),
	...
	app["post"]("/svr/students", function (w, S) {
		let d = w["body"];
		console["log"](d);
		let q = studentsData["reduce"]((B, e) => (e["id"] >= B ? e["id"] : B), 0x0),
			E = q + 0x1,
			f = {
				id: E,
				...d,
	...
	app["put"]("/svr/students/:id", function (w, S) {
		let d = +w["params"]["id"],
			q = w["body"],
			E = studentsData["findIndex"]((f) => f["id"] === d);
		if (E >= 0x0) {
			let f = {
				id: d,
				...q,
	...
	app["delete"]("/svr/students/:id", function (w, S) {
		let d = +w["params"]["id"],
			q = studentsData["findIndex"]((E) => E["id"] === d);
		if (q >= 0x0) {
